...
<%@ page import="com.example.springadminhanamvcjsp.data.dto.CustomerResponseDTO" %>
...
<%
  ...
  List<CustomerResponseDTO> tempList = (List<CustomerResponseDTO>) request.getAttribute("customerList");
  if (tempList != null) {
